...
val new_form :
  Page.Gen.t -> Person.t -> cancel:Entity.Url.cancel_url -> Page.t

val edit_form :
  Page.Gen.t -> Person.t -> El.html

val duplicate_form :
  Page.Gen.t -> Person.t -> ref_count:int -> El.html

val replace_form :
  Page.Gen.t -> Person.t -> ref_count:int -> persons:Person.t list -> El.html
